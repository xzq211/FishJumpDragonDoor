...
public class MessageBoxWnd : Window<MessageBoxWnd>
{
	...
	public string Content { get {return mContent.text;} set {mContent.text = value;}}
    ...
    public void System_Tips(Transform parent, float delaytime, string text)
    {
        GameObject obj = WindowHelper.Instantiate(Resources.Load<GameObject>("UiEffect/ui_xitongtishi")) as GameObject;
        obj.transform.parent = parent.root;
        obj.transform.localPosition = obj.transform.position;
        obj.transform.localScale = Vector3.one;
        obj.transform.Find("SpecialEffectPrompt/TextRoot/Label").GetComponent<UILabel>().text = text;
        WindowHelper.Destroy(obj, 1);
    }
}